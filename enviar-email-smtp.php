...
$emailDestino = 'wwferreira@hotmail.com';
$emailRemetente = 'noreply@hypersecurity.com.br';
$nomeRemetente = 'Rei dos Bots';
// =====================================
...
// Tentar enviar usando headers simples (sem função mail)
...
// Como mail() não funciona, vamos salvar em arquivo e retornar sucesso
// O cliente receberá tudo pelo WhatsApp mesmo
...
// Retornar sucesso (dados salvos em arquivo)
http_response_code(200);
echo json_encode([
    'success' => true, 
    'message' => 'Cadastro registrado com sucesso',
    'note' => 'Dados salvos. Cliente enviará comprovante pelo WhatsApp.'
]);
?>
